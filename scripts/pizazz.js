...
var colors = ['tomato', 'DodgerBlue', 'BlueViolet', 'Gold', 'SpringGreen', 'HotPink', 'Cyan', 'OrangeRed'];

Pizazz.prototype.play = function(target, d) {
  var canvas = getCanvas();
  var dimensions = target.getBoundingClientRect ? target.getBoundingClientRect() : target;
